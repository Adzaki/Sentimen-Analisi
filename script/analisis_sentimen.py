...
try:
    ...
    draw.text((title_x + 3, y_pos + 3), title_text, fill='#1e40af', font=font_title)
    draw.text((title_x, y_pos), title_text, fill='#1e3a8a', font=font_title)
    ...
    draw.text((col1_x, stats_y + 50), str(total), anchor="mm", fill='#1e3a8a', font=font_label)
    ...
    draw.text((col2_x, stats_y + 50), f"{overall_conf:.1f}%", anchor="mm", fill='#1e3a8a', font=font_label)
    ...
    if accuracy is not None:
        ...
        draw.text((col3_x, stats_y + 50), f"{accuracy:.1f}%", anchor="mm", fill='#10b981', font=font_label)
    else:
        draw.text((col3_x, stats_y), "Sentimen Dominan", anchor="mm", fill='#374151', font=font_stats)
        dominant = sentiment_counts.idxmax()
        draw.text((col3_x, stats_y + 50), label_mapping[dominant], anchor="mm", fill='#10b981', font=font_label)
    ...
    print(f"        Pastikan PIL/Pillow sudah terinstall: pip install pillow")
    poster_path = None
